...
| `elements/pl-multiple-choice` | In review | Added hint attribute to pl-answer element in pl-multiple-choice. See [pull request #4656 on PrairieLearn](https://github.com/PrairieLearn/PrairieLearn/pull/4656) for details. | @Cristian Moran |